...
<body>
    ...
    <section class="banner">
        <div class="container">
            <div class="banner-align ">
                ...
                <div class="banner_right" style=""></div>
            </div>
        </div>
    </section>
    <!-- Banner ends -->
    ...
    <section class="services">
        <div class="container">
            ...
            <h4 data-aos="fade-up" class="slide_subtext">You Need Solutions</h4>
            ...
            <div class="slider-nav">
                ...
                <div class="item">
                    ...
                    <div class="right flex-7">
                        <img src="images/service7.jpg" alt="services" width="671" height="482">
                    </div>
                </div>
            </div>
                    ...
                    <div class="content_wrapper">
                        <div class="card active" id="resource-one">
                            ...
                            <p>
                                ...
                                are
                                commonly found in Laravel applications. Watch me creating <span>Smartboxx</span>- a
                                device booking
                                web
                                application with all the security features.
                            </p>
                            <button class="btn-primary resource_profile_popup" data-content="Kirti">Hire
                                Kirti</button>
                        </div>
                        <div class="card" id="resource-two">
                            ...
                            <p>
                                ...
                                You probably know me as the creator of <span>BleenTravel</span>, a property booking
                                application like
                                Airbnb. When I'm not writing code, you'll find me Pentesting (yes that’s coding too).

                            </p>
                            <button class="btn-primary resource_profile_popup" data-content="Vivek">Hire
                                Vivek</button>
                        </div>
                        <div class="card" id="resource-three">
                            ...
                            <p>
                                ...
                                I love big numbers. For my last Laravel Web Development project, I created a <span>SaaS
                                    application</span> that helped my client gain a huge profit in just 45 days. Right
                                now am
                                creating
                                libraries that make developers easier to write code.
                                es.
                            </p>
                            <button class="btn-primary resource_profile_popup" data-content="Mohit">Hire
                                Mohit</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="container get_trail_section_wrapper flexbox ">
            ...
            <div class="flex-6 get_started_right" id="form">
                <div class="get_started_form ">
                    <div class="lg-border">
                        <h4 class="text_center">Share Your Requirement</h4>
            ...
            <div class="client_slider owl-carousel">
                <div class="item">
                    <div class="wrap">
                        ...
                        <div class="clinet_info square left right">
    ...
    <div class="footer_section">
        <div class="container">
            <div class="footer_wrapper ">
                <h2 class="text_center">We Love Focusing on User Outcomes<br />
                    Not Just Code</h2>
                <button class="btn-primary smoothscroll" data-target="#form">Hire Laravel Developer</button>
            </div>
        </div>
    ...
    // lifeCycle process Scroll on mouseWheel
    jQuery(function($) {
        if ($(window).width() > 992) {
    ...
    // Slick slider for Service with progress bar
